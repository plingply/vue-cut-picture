  ...
  install(Vue) {
    ...
    Vue.prototype.initFunction = function () {
      ...
      this.addEvent(this.cancelBtn, 'click', function () {
        self.destoried();
        typeof self.options.cancelfun === "function" ? self.options.cancelfun() : ''
      })
      //清空input的值
    ...
    Vue.prototype.clip = function (e, opt) {
      ...
      typeof opt.loadImgfun === "function" ? opt.loadImgfun() : ''
    ...
    Vue.prototype.crop = function () {
      ...
      typeof self.options.loadingfunc === "function" ? self.options.loadingfunc() : ''
    ...
    Vue.prototype.postImg = function (imageData) {
      //这边写图片的上传
      let self = this;
      typeof self.options.upload === "function" ? self.options.upload(imageData) : console.error("upload参数，必填，为函数")
    }
